...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
     ...
     */
     int d = abs(theCenterX-x) + abs(theCenterY - y);
     if ( d < theRadius){
     	color.red = color1.red - (d * color1.red / theRadius) + (d * color2.red / theRadius);
     	color.green = color1.green - (d * color1.green / theRadius) + (d * color2.green / theRadius);
     	color.blue = color1.blue - (d * color1.blue / theRadius) + (d * color2.blue / theRadius);
     }
     else {
     	color = color2;
     }
